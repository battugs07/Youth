              ...
              child: BaseView<ResolutionModel>(
                ...
                builder: (context, model, child) => model.loading
                    ...
                    : SmartRefresher(
                        ...
                        onRefresh: () async {
                          await model.getResolutionList(widget.aimagId!, 81, 1, action: "refresh");
                          await Future.delayed(Duration(milliseconds: 1000));
                          _refreshController.refreshCompleted();
                        },
                        onLoading: () async {
                          await model.getResolutionList(widget.aimagId!, 81, model.page + 1, action: "more");
                          await Future.delayed(Duration(milliseconds: 1000));
                                                    ...
                                                    child: item.thumb != null
                                                        ...
                                                        : Container(
                                                            decoration: BoxDecoration(
                                                              image: DecorationImage(
                                                                  image: NetworkImage(
                                                                    baseUrl + "/assets/youth/images/bg-legal-tailan.jpg",
                                                                  ),
                                                                  fit: BoxFit.cover),
                                                            ),
                                                          ),
