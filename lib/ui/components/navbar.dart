...
class MD2Indicator extends Decoration {
  ...
  const MD2Indicator({this.indicatorHeight, this.indicatorColor, this.indicatorSize});
...
class _MD2Painter extends BoxPainter {
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    ...
    if (decoration!.indicatorSize == MD2IndicatorSize.full) {
      ...
      rect = Offset(offset.dx + configuration.size!.width / 2 - 12, (configuration.size!.height - decoration!.indicatorHeight! ?? 3)) &
    ...
    canvas.drawRRect(
        RRect.fromRectAndCorners(rect!,
            topRight: Radius.circular(8), topLeft: Radius.circular(8), bottomRight: Radius.circular(8), bottomLeft: Radius.circular(8)),
        paint);
  }
}
